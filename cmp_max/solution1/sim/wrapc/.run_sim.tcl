...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "cmp_max.autotvin.dat"
	set constFileTvOut       "cmp_max.autotvout.dat"
	set constFileHdlTvIn     "cmp_max.autohdltvin.dat"
	set constFileHdlTvOut    "cmp_max.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
