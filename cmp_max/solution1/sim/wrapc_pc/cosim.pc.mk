...
$(ObjDir)/cmp_max_test.c_pre.c.tb.o : cmp_max_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) cmp_max_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/cmp_max.c_pre.c.tb.o : cmp_max.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) cmp_max.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
