 ...
 * {@link Network} and {@link Network_iface}. Feel free to use,
...
public class Example implements Network_iface {
	...
	/**
	 * Implementing {@link Network_iface#networkDisconnected(int)}, which is
	...
	/**
	 * Implementing {@link Network_iface#parseInput(int, int, int[])} to
